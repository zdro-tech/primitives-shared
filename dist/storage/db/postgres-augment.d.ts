...
declare module 'postgres' {
    interface TransactionSql<TTypes extends Record<string, unknown> = {}> {
        <T extends readonly (object | undefined)[]>(template: TemplateStringsArray, ...parameters: readonly (postgres.ParameterOrFragment<TTypes[keyof TTypes]>)[]): postgres.PendingQuery<T>;
        <T, K extends readonly any[]>(first: T, ...rest: K): postgres.Helper<T, K>;
    }
}
//# sourceMappingURL=postgres-augment.d.ts.map