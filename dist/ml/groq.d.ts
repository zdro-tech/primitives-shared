...
export declare const newGroqCompletion: (messages: Array<ChatCompletionMessageParam>, model: string, mode?: string, modelSettings?: Record<string, unknown>) => Promise<ChatCompletion.Choice[]>;
