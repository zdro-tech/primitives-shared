...
export const newO3MiniCompletition = async (messages, mode) => await createChatCompletion({ ...defaultOpenAISettings, model: "o3-mini", messages, max_completion_tokens: 2000, temperature: 1 }, mode);
