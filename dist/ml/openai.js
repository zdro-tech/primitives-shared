...
export const newO3Completition = async (messages, mode) => await createChatCompletion({ model: "o3", reasoning_effort: "medium", messages, max_completion_tokens: 8192 }, mode);
export const newO4MiniCompletition = async (messages, mode) => await createChatCompletion({ model: "o4-mini", reasoning_effort: "low", messages, max_completion_tokens: 8192 }, mode);
...
export const newGPT41Completition = async (messages, mode) => await createChatCompletion({ model: "gpt-4.1", messages, max_completion_tokens: 8192 }, mode);
export const newGPT41MiniCompletition = async (messages, mode) => await createChatCompletion({ model: "gpt-4.1-mini", messages, max_completion_tokens: 8192 }, mode);
export const newGPT41NanoCompletion = async (messages, mode) => await createChatCompletion({ model: "gpt-4.1-nano", messages, max_completion_tokens: 8192 }, mode);
